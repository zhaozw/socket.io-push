 ...
 * @since 4.0
 */
public class PrincipleWebSocketHandler extends DefaultHandshakeHandler {

    protected Log logger = LogFactory.getLog(getClass());

//    private static final boolean glassFishWsPresent = ClassUtils.isPresent(
//            "org.glassfish.tyrus.servlet.TyrusHttpUpgradeHandler", PrincipleWebSocketHandler.class.getClassLoader());
//
//    private static final boolean jettyWsPresent = ClassUtils.isPresent(
//            "org.eclipse.jetty.websocket.server.WebSocketServerFactory", PrincipleWebSocketHandler.class.getClassLoader());
//
//    private static final boolean tomcatWsPresent = ClassUtils.isPresent(
//            "org.apache.tomcat.websocket.server.WsHttpUpgradeHandler", PrincipleWebSocketHandler.class.getClassLoader());
//
//    private static final boolean undertowWsPresent = ClassUtils.isPresent(
//            "io.undertow.websockets.jsr.ServerWebSocketContainer", PrincipleWebSocketHandler.class.getClassLoader());
//
//
...
//     * {@link org.springframework.web.socket.server.RequestUpgradeStrategy} suitable for the runtime container.
//     *
//     * @throws IllegalStateException if no {@link org.springframework.web.socket.server.RequestUpgradeStrategy} can be found.
//     */
//    public PrincipleWebSocketHandler() {
...
//        }
//        try {
//            Class<?> clazz = ClassUtils.forName(className, PrincipleWebSocketHandler.class.getClassLoader());
...
//
//    /**
//     * A constructor that accepts a runtime-specific {@link org.springframework.web.socket.server.RequestUpgradeStrategy}.
//     *
//     * @param requestUpgradeStrategy the upgrade strategy to use
//     */
//    public PrincipleWebSocketHandler(RequestUpgradeStrategy requestUpgradeStrategy) {
...
//     * {@link org.springframework.web.socket.SubProtocolCapable} then there is not need to explicitly configure
...
//     * WebSocketHandler is a {@link org.springframework.web.socket.SubProtocolCapable} and then also checks if any
...
//     * whether it is an instance of {@link org.springframework.web.socket.SubProtocolCapable}.
//     *
...
//    }
    ...
    protected Principal determineUser(ServerHttpRequest request, WebSocketHandler wsHandler,
        ...
        stompPrincipal.setRemoteIp(request.getRemoteAddress().getAddress().getHostAddress());
        logger.info("client connected " + stompPrincipal.getRemoteIp());
