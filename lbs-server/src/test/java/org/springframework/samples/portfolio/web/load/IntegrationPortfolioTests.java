...
//        URI uri = new URI("ws://183.60.221.91:9100/stomp");
...
//                        stompSession.subscribe("/user/queue/reply", null);
...
//                                        e.printStackTrace();
//                                    }
//                                    logger.info("send test " + integer.incrementAndGet());
//                                    System.out.println("send test " + integer.incrementAndGet());
//                                    stompSession.send("/app1/test", "");
//                                }
//                            }
//                        }).start();
                    }
