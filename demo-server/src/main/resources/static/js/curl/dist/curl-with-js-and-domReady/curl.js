(function () {/*
 MIT License (c) copyright 2010-2013 B Cavalier & J Hann */
    (function (r) {
        ...
        function p(a, b, d) {
            var c, f, g;
            if (a && (k.R(a), m = k.b(a), "preloads"in a && (c = new h(a.preloads, s, d, H, !0), k.N(function () {
                H = c
        ...
        function K(a) {
            var b, d;
            b = a.id;
            b == s && (I !== s ? I = {H: "Multiple anonymous defines encountered"} : (b = k.ca()) || (I = a));
            if (b != s) {
                d = v[b];
        ...
        var m, q, J, G = r.document, t = G && (G.head || G.getElementsByTagName("head")[0]), V = t && t.getElementsByTagName("base")[0] || null, P = {}, Q = {}, L = {}, W = "addEventListener"in r ? {} : {loaded: 1, complete: 1}, N = {}, S = N.toString, s, v = {}, M = {}, H = !1, I, R = /^\/|^[^:]+:\/\//, T = /(\.)(\.?)(?:$|\/([^\.\/]+.*)?)/g, X = /\/\*[\s\S]*?\*\/|\/\/.*?[\n\r]/g, Y = /require\s*\(\s*(["'])(.*?[^\\])\1\s*\)|[^\\]?(["'])/g, U = /\s*,\s*/, O, k;
        k = {n: function (a, b, d) {
            var c;
            a = E(a, b);
            ...
            var b =
                a.s;
            b || (b = a.s = {id: a.id, uri: k.K(a), exports: k.J(a), config: function () {
                return a.b
            }}, b.a = b.exports);
            return b
        }, K: function (a) {
            ...
            d = "define";
            c = f = r;
            if (a && (g = a.overwriteApi || a.na, b = a.apiName || a.ia || b, c = a.apiContext || a.ha || c, d = a.defineName || a.ka || d, f = a.defineContext || a.ja || f, q && w(q, "Function") && (r.curl = q), q = null, J && w(J, "Function") && (r.define = J), J = null, !g)) {
                if (c[b] && c[b] != e)throw Error(b + " already exists");
                if (f[d] && f[d] != F)throw Error(d +
                    " already exists");
            }
            c[b] = e;
            f[d] = F
            ...
            b(a.packages, !0);
            b(a.paths, !1);
            for (n in g)a = k.n(n + "!", "", f), f.plugins[a.substr(0, a.length - 1)] =
                g[n];
            g = f.plugins;
            ...
            if (!(e in v))if (s = k.j(p, f).b, g.d)q = h; else if (q = s.moduleLoader || s.ma || s.loader || s.la)p = h, h = q, r = k.j(q, f);
            h in v ? l = v[h] : r.url in M ? l = v[h] = M[r.url] : (l = k.D(s, h, c), l.url = k.C(r.url, r.b), v[h] = M[r.url] = l, k.Y(l));
        ...
        O = {require: k.ba,
            exports: k.J, module: k.aa};
        e.version = "0.8.1";
        e.config = p;
        F.amd = {plugins: !0, jQuery: !0, curl: "0.8.1"};
        m = {o: "", P: "curl/plugin", i: /\?|\.js\b/, u: {}, t: {}, plugins: {}, c: {}, O: /$^/};
        m = k.W(m);
        q = r.curl;
        J = r.define;
        q && w(q, "Object") || m.m ? (r.curl = s, p(q || m)) : k.R();
        v.curl = e;
        v["curl/_privileged"] = {core: k, cache: v, config: function () {
            return m
        }, _define: K, _curl: e, Promise: D}
    ...
    (function (r, l) {
        ...
        var C = "readyState", A = {loaded: 1, interactive: 1, complete: 1}, y = [], D = l && "string" != typeof l[C], z = !1, u = 10, B, e, p = [], h, K, F;
        ...
        l && !x() && (p = [B(r, "load"), B(l, "readystatechange"), B(r, "DOMContentLoaded")], h = setTimeout(E, u));
    ...
    (function (r, l, w) {
        define("curl/plugin/js", ["curl/_privileged"], function (r) {
            function E(e, p, h) {
                function l() {
            ...
            z = r.Promise;
            return{dynamic: !0, normalize: function (e, p) {
                var h = e.indexOf("!");
                ...
                {name: e, url: t, ea: m, a: w, fa: l.timeout}, A[t] = p = new z, p.k(function (e) {
                    A[t] = e;
                    h(e)
    ...
    define("curl/plugin/domReady", ["../domReady"], function (r) {
        return{load: function (l, w, x) {
            r(x)
        }}
    });
}).call(this);
